...
import { hygiene, notesSmell, formulaCellsRule, proseUnanchoredSnapshot } from "./rules/hygiene.ts";
...
const rules = [referential, arithmetic, qualifiedFill, statusWindow, standingsStates, duplicateRanks, appliesToBinds, confirmedPlaceholderDates, completedWithoutOutcome, storedQualificationShadowed, tzProvenance,
               ...
               fixturesBeforeStart, missingEarlierRounds, placeholderFixtures, roundRobinIncomplete, namedContinentsDeclared, poolPreview, hygiene, notesSmell, formulaCellsRule, proseUnanchoredSnapshot];
